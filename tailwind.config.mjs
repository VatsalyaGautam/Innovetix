...
export default {
  ...
  theme: {
    extend: {
      ...
      animation: {
        rollInFromLeftCustom: "rollInFromLeftCustom  0.69s ease-out",
        rollInFromRightCustom: "rollInFromRightCustom  0.69s ease-out",
