...
<>
  ...
  <div className=" max-w-[100%] bg-gradient-to-t to-[#0E0C44] from-[#D83D79] mx-auto flex flex-col md:flex-row items-center sm:items-start lg:items-center justify-around px-6 sm:px-3 lg:px-6 py-12 mt-16 sm:mt-20 2xl:mt-20 z-10">
  ...
  <ScrollReveal animation='fadeIn' duration={800} className=" w-[100%] sm:w-auto xl:w-[35%] 2xl:w-[30%] flex justify-center items-center lg:block">
   <Image
             src="/Serviceideation/Image1.png"
              ...
              className="p-1 w-[350px] md:w-[400px] lg:w-[500px] 2xl:w-[600px]"
            />
  </ScrollReveal>
</div>
...
<div className="flex justify-between relative ">
      ...
      >
        ...
        >
          ...
          <h3 className="text-xl text-start font-semibold mb-3 leading-tight">  Get human-centric designs that forge </h3>
          <p className="text-gray-600 text-start">  Get human-centric designs that forge strong customer relationships & help your businesses thrive</p>
        </div>
