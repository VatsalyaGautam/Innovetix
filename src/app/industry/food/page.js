    ...
    <>
      ...
      <div className="bg-[rgb(13,13,13)] text-white relative overflow-hidden mt-40 py-6 w-full h-auto">
        <div className="px-5 md:max-w-8xl lg:max-w-[101rem] mx-auto flex flex-col">
          ...
          <div className="relative py-5 md:py-20 flex flex-col items-center">
            <Image
              src="/food/leftFood.png"
              width={335}
              height={335}
              alt="Pasta"
              className="absolute top-1/2 -ml-[30%]  lg:-ml-[18%] xl:-ml-[11%] left-0 -translate-y-1/2"
            />
            <Image
              ...
              height={332.73}
              alt="Paneer"
              className="absolute top-1/2 -mr-[30%] lg:-mr-[18%] xl:-mr-[11%] right-0 -translate-y-1/2"
            />
            ...
            <div className="z-10 text-center max-w-5xl mx-auto flex flex-col items-center">
              ...
              {/* Tech categories */}
              <div className="flex flex-col md:flex-row justify-center gap-1 md:gap-8 my-8">
              ...
              {/* Bottom text */}
              <p className="text-center text-sm md:text-base mt-6 mb-6 md:mb-0 max-w-3xl opacity-90">
      ...
      <div className="bg-white">
        <div className="bg-white px-5 md:max-w-5xl lg:max-w-6xl mx-auto flex flex-col gap-4 mb-16">
          {/* Sec 3 start */}
          <div className="w-full bg-white pt-10 md:py-10">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              {/* Heading Section */}
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-10 md:mb-16 max-w-5xl mx-auto leading-tight">
                We've Helped Over 9 Multi-Million Dollar Food Startups In The
                Last Six Years And The Numbers Speak Themselves
              </h2>

              {/* Stats Cards */}
              <div className="flex flex-col md:flex-row gap-4 md:gap-6 mb-12 md:mb-20 justify-center">
                {/* Stat Card 1 */}
                <div className="flex-1 border border-orange-200 rounded-lg p-6 bg-orange-50 flex items-center gap-4">
                  <div className="w-16 h-16 flex-shrink-0">
                    ...
                    <Image src="/food/ordersProcessed.svg" width={64} height={52.36} alt="orders"/>
                  </div>
                  <div>
                    <h3 className="text-4xl font-bold">1.5M</h3>
                    <p className="text-lg text-gray-700 !leading-tight">Orders Processed</p>
                  </div>
                </div>
                ...
                <div className="flex-1 border border-orange-200 rounded-lg p-6 bg-orange-50 flex items-center gap-4">
                  <div className="w-16 h-16 flex-shrink-0">
                    ...
                    <Image src="/food/customerReviews.svg" width={64} height={63.47} alt="Customer Reviews"/>
                  </div>
                  <div>
                    <h3 className="text-4xl font-bold">60K</h3>
                    <p className="text-lg text-gray-700 !leading-tight">Customer Reviews</p>
                  </div>
                </div>
                ...
                <div className="flex-1 border border-orange-200 rounded-lg p-6 bg-orange-50 flex items-center gap-4">
                  <div className="w-16 h-16 flex-shrink-0">
                    ...
                    <Image src="/food/monthlyTransactions.svg" width={64} height={63.41} alt="monthly transactions"/>
                  </div>
                  <div>
              ...
              <div className="w-full bg-black text-white rounded-xl overflow-hidden">
                <div className="flex flex-col md:flex-row">
                  <div className="hidden md:flex flex-col md:w-1/3 relative justify-end">
        ...
        <div className="bg-[#E03032] px-5 md:max-w-7xl lg:max-w-[88rem] mx-auto flex flex-col">
          <div className=" text-white py-16 px-4 
            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 lg:space-x-12">
              ...
              <div className="w-full h-full lg:w-1/2 flex justify-center lg:justify-left relative
              md:max-w-[696px]
              lg:max-w-[452px]
              xl:max-w-[580px]
              ">
                ...
                <Image
                  ...
                  height={360.99}
                  src="/food/pizza.svg"
                  className="absolute z-0 w-[47%] top-8 right-24 
            ...
            <div className="flex gap-4 pb-24">
              <div className="grid md:grid-cols-1 gap-6 w-1/2">
                {features.map((feature, index) => (
                  <Card
                    key={index}
                    className="bg-[#E5D5C0] border-none shadow-md hover:shadow-lg transition-shadow duration-300"
                  >
                    <CardContent className="p-6 relative">
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-700 md:!mt-1">{feature.description}</p>
                      </div>
              ...
              <div className="mt-8 flex justify-center relative w-1/2">
                <div className="w-full max-w-4xl">
                  {/* Placeholder for screenshots/UI mockup */}
                  <div className="h-[400px] rounded-lg flex items-center justify-center">
                    <Image src="/food/thirdLast.svg" width={548} height={474.05} alt="laptop and mobile"/>
                  </div>
                </div>
              </div>
            </div>
