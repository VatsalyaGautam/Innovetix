...
import { Users, Building2, DollarSign,ChevronRight, ChevronsRight } from "lucide-react";
...
function page() {
  ...
  const getDelay=(index)=>{
    ...
    return (
    <ScrollReveal animation={getAnimation(index)} delay={getDelay(index)} duration={800} easing="smooth" className="bg-[#C59E12] px-6 pt-6 pb-12 rounded-lg flex flex-col relative md:p-10 md:pb-16">
    ...
    <>
      ...
      <div className="w-full px-5 md:max-w-5xl lg:max-w-[88rem] mx-auto flex flex-col sm:flex-row py-16">
        ...
        <div className="w-full mb-4 sm:mb-0 sm:w-1/2 flex flex-col h-full my-auto justify-center items-center">
          <div className="flex flex-col gap-4 sm:gap-20">
            <div className="flex flex-col gap-6">
              ...
              <ScrollReveal animation="slideRight" duration={800} easing="spring">
        ...
        <div className="w-full sm:w-1/2 h-[20rem] md:h-[30rem] flex justify-center relative items-center">
          <ScrollReveal animation="fadeSlideLeft" duration={900} delay={300} easing="gentle"  className="w-full h-auto">
      ...
      <div className="bg-slate-50">
        <div className="bg-slate-50  h-auto py-16 md:py-28 w-full px-5 md:max-w-5xl lg:max-w-6xl mx-auto flex flex-col gap-6 md:gap-24">
          ...
          <ScrollReveal animation="slideDown" duration={800} easing="spring" delay={200} >
            <h2
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-y-12">
            {studioCards.map((ele, idx) => {
              return (
                <ScrollReveal key={idx} animation={idx/2<=1?`slideRight`:`slideLeft`} duration={1000} easing="bouncy">
                <div className="p-4" >
                  {" "}
      ...
      <div className="bg-black  bg-[url('/studio/studioMain.svg')] bg-no-repeat bg-cover">
        <div className=" h-auto relative w-full px-10 xl:px-5 md:max-w-5xl lg:max-w-[88rem] mx-auto flex flex-col py-16 md:py-28 ">
          <ScrollReveal  animation="slightLeft" duration={800} easing="gentle" className="hidden xl:block absolute top-32 right-36 w-auto h-auto opacity-50"> 
        <Image
          ...
          <ScrollReveal  animation="slideRight" duration={800} easing="gentle" className="hidden xl:block  absolute top-16 left-48 w-auto h-auto opacity-50"> 
          <Image
            src="/studio/stars.svg"
            alt="stars"
            width={105}
          ...
          {/* Header section */}
          <div className="mb-4">
          <ScrollReveal animation="slideDown" duration={800} delay={200}  easing="spring">
